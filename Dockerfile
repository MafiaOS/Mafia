...
#Import Gudz
RUN wget https://raw.githubusercontent.com/MrDevilUltra/DEVILULTRA/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/MrDevilUltra/DEVILULTRA/master/requirements.txt
#Start Fumkin
